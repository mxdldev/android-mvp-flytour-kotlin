 ...
 * Update:     <br>
 */
class NewsListPresenter(context:Context): BaseRefreshPresenter<NewsListModel,NewsListContract.View<NewsDetail>,NewsDetail>(context),NewsListContract.Presenter {
